          ...
          Row(
            ...
            children: [
              Wrap(
                spacing: 24,
                children: [
                  _LegendItem(title: 'Total Revenue', dateRange: '12.04.2022 - 12.05.2022', color: AppColors.tailAdminPrimary),
                  _LegendItem(title: 'Total Sales', dateRange: '12.04.2022 - 12.05.2022', color: AppColors.tailAdminChartBlue),
                ],
              ),
              Row(
                children: [
              ...
              LineChartData(
                ...
                borderData: FlBorderData(
                  ...
                  border: Border(
                    ...
                    left: BorderSide(color: theme.colorScheme.outline.withOpacity(isDark ? 0.2 : 0.5)),
                  ),
                ),
                minX: 0,
                ...
                lineBarsData: [
                  ...
                  LineChartBarData(
                    ...
                    belowBarData: BarAreaData(
                      show: true,
                      color: AppColors.tailAdminChartBlue.withOpacity(0.1),
                    ),
                  ),
                ],
              ),
...
class _LegendItem extends StatelessWidget {
  ...
  const _LegendItem({required this.title, required this.dateRange, required this.color});
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(dateRange, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
          ],
        )
      ],
    );
